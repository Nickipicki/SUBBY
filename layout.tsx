  ...
  return (
    <html lang="de">
      ...
      <body className={`${inter.className} pt-7`}>
        {/* Beta Banner */}
        <div className="fixed top-0 left-0 right-0 bg-gradient-to-r from-purple-500 to-indigo-500 text-white text-center py-1.5 text-sm font-medium z-[9999] shadow-md">
