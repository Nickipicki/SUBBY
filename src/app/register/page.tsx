...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex flex-row-reverse bg-[#0B0F19] relative overflow-hidden justify-center gap-32">
      ...
      <div className="hidden lg:flex absolute left-1/2 top-[15%] -translate-x-1/2 z-10">
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-1">
          <div className="relative flex space-x-1">
            <div className="absolute bg-gradient-to-r from-purple-500 to-indigo-500 h-full w-1/2 rounded-xl transition-all duration-300 left-1/2" />
            <Link
              href="/login"
      ...
      <motion.div 
        className="w-full lg:w-[600px] flex items-center justify-end relative"
        initial={{ x: "-100%", opacity: 0, scale: 0.8 }}
        animate={{ x: 0, opacity: 1, scale: 1 }}
        exit={{ x: "100%", opacity: 0, scale: 0.8 }}
        transition={{
